...
## DICOM loading
DICOM loading is using a binary version of DCMTK library, you can find their full license at their [github](https://github.com/DCMTK/dcmtk/blob/master/COPYRIGHT)# Volumatrix
